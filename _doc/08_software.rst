...
Ogni componente utilizzato dai dipendenti di Corte è collegato ad una :term:`licenza d’uso<Licenza d’uso>` che ne consente la fruizione nei limiti e  termini connessi al contesto di utilizzo.  Su indicazione dei responsabili degli uffici, in relazione allo svolgimento di specifiche attività lavorative, alcune postazioni potranno essere dotate di programmi aggiuntivi che dovranno comunque soddisfare la *policy* di sicurezza ed i prerequisiti software definiti dalla Corte dei conti.

.. |Lente di ingrandimento| image:: https://static.vecteezy.com/ti/foto-gratuito/p2/1920200-lente-di-ingrandimento-on-white-background-gratuito-foto.JPG
	:height: 16px
